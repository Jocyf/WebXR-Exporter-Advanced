...
public class LaserPointer : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        if (_hitTarget)
        {
            ...
            {
                cursorVisual.transform.position = _endPoint + _normal * 0.01f;  /**/
                cursorVisual.SetActive(true);
                cursorVisual.transform.rotation = Quaternion.LookRotation(-_normal); ; // Quaternion.FromToRotation(Vector3.up, _normal); /**/
            }
        }
        else
        {
