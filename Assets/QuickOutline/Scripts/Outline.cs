...
namespace OutlineUtils
{
    ...
    public class Outline : MonoBehaviour {
        ...
        private bool isOutlineReady = false;

        [Header("Runtime Watchers")]
        [Disable]
        [SerializeField]
        private List<Vector3> smoothNormals;

        [InspectorButton("GenerateOutline")]
        public bool generate;

        [InspectorButton("ClearOutline")]
        public bool clear;

        public bool IsOutlineReady() { return isOutlineReady; }
        ...
        private void Awake()
        {
            ...
            StartCoroutine(LoadSmoothNormals());
        ...
        private void Bake()
        {
            ...
            foreach (MeshFilter meshFilter in GetComponentsInChildren<MeshFilter>())
            {
                ...
                StartCoroutine(SmoothNormals(meshFilter.sharedMesh));
        ...
        // Retrieve or generate smooth normals
        private IEnumerator LoadSmoothNormals()
        {
            foreach (MeshFilter meshFilter in GetComponentsInChildren<MeshFilter>())
            {
                ...
                {
                    yield return StartCoroutine(SmoothNormals(meshFilter.sharedMesh));
                    isOutlineReady = true;
                }
        ...
        private IEnumerator SmoothNormals(Mesh mesh)
        {
